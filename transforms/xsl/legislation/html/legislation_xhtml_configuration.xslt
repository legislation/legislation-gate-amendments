...
<xsl:param name="g_strImagesPath" select="concat($g_ndsLegisConfigDoc//path[@type = 'images']/@href, '/')"/>

<!-- Path to where styles are. -->
<xsl:param name="g_strStylesPath" select="concat($g_ndsLegisConfigDoc//path[@type = 'CSS']/@href, '/')"/>
