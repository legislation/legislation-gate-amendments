...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.w3.org/1999/xhtml"  version="2.0" 
	...
	<xsl:template name="TSOOutputSubNavTabs">
		<ul id="legSubNav">
				...
				<xsl:if test="$IsUpdatesFeedAvailable">
					<li id="legUpdatesLink">
						<span class="presentation"></span>
						<a href="{leg:FormatURL($updateFeedURI, false())}">Outstanding Updates</a>
						<a href="#moreResourcesTabHelp" class="helpItem helpItemToBot">
							<img src="/images/chrome/helpIcon.gif" alt=" Help about More Resources"/>
						</a>
					</li>
				...
				<xsl:if test="$supportParticipation and not(/*/ukm:Metadata/ukm:Revisions)">
					<li id="legParticipationLink">
						<span class="presentation"></span>
						<a href="{leg:FormatURL(replace($resourceURI, '/resources', '/participation'), false())}">Participation</a>
						<a href="#participationTabHelp" class="helpItem helpItemToBot">
							<img src="/images/chrome/helpIcon.gif" alt=" Help about Participation"/>
						</a>
					</li>
				</xsl:if>
		</ul>			
	...
	<xsl:template name="TSOOutputENsHelpTips">
		...
		<xsl:if test="$supportParticipation">
			<div class="help" id="participationTabHelp">
				<span class="icon"/>
				<div class="content">
					<a href="#" class="close">
						<img alt="Close" src="/images/chrome/closeIcon.gif"/>
					...
					<h3>Participation</h3>
					<p>Access contributed content and methods of updating legislation.</p>
				</div>
			</div>			
		</xsl:if>
	</xsl:template>
	...
	<xsl:function name="leg:get-query-param" as="xs:string">
		<xsl:param name="params" as="xs:string" />
		<xsl:sequence select="substring-after(leg:get-query($params), '=')" />
	</xsl:function>
