			...
			<body lang="en" xml:lang="en" dir="ltr" id="browse" class="intro"> 
				<div id="layout2" >
					...
					<div id="content">
						...
						<xsl:variable name="nonDraftTypes" select="$tso:legTypeMap[not(@class = ('draft','IA', 'euretained'))]" />
						...
						<div class="s_8 p_one">					
							<div class="s_4 p_one legCol">
								...
								<ul class="legTypes">
									...
									<li> <a id="ukmd" href="/ukmd">UK Ministerial Directions<span></span></a> </li>
							...
							<div class="s_4 p_two legCol">
								...
								<ul class="legTypes">
									...
									<li> <a id="nisro" href="/nisro">Northern Ireland Statutory Rules and Orders 1922-1973<span></span></a> </li>
						...
						<div class="s_8 p_one">		
							...
							<div class="s_4 p_two legCol">
								...
								<ul class="legTypes">
									...
									<li> <a id="ukmd" href="/ukmd">UK Ministerial Directions</a> </li>
									<li> <a id="uksro" href="/uksro">UK Statutory Rules and Orders 1900-1948<span></span></a> </li>
									<li> <a id="ukdsi" href="/ukdsi">UK Draft Statutory Instruments<span></span></a> </li>
								</ul>
							</div>
